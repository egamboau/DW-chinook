...
BEGIN
SET @DateId = CONVERT (char(8),@CurrentDate,112)

IF NOT EXISTS (SELECT DT_DateID FROM DT_Date DT_D WHERE DT_D.DT_DateID = @DateId)
BEGIN
...
/* Populate Your Dimension Table with values*/
 ...
 SELECT
  ...
  CONVERT (char(8),@CurrentDate,112) as DT_DateID,
  @CurrentDate AS Date,
